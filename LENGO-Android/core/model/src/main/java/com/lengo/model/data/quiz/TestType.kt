...
//    @Stable
//    override val pointEarn: State<Int>
//        get() = derivedStateOf {
//            if (answerSubmittedState.value.isAnswered) {
//                if (isCorrectAnswer(correctAnsText.text, answerSubmittedState.value.answerSubmitted)
...
//        }
    ...
    @Stable
    val fieldColorState: State<ColorState>
        get() = derivedStateOf {
            if (answerSubmittedState.value.isAnswered) {
                if (isCorrectAnswer(correctAnsText.text, answerSubmittedState.value.answerSubmitted)
                    && !answerSubmittedState.value.isTakeHint
                    ...
                    ColorState.GREEN
                } else if (isCorrectAnswer(correctAnsText.text, answerSubmittedState.value.answerSubmitted)
                    && answerSubmittedState.value.isTakeHint
                ) {
                    ColorState.YELLOW
                } else {
