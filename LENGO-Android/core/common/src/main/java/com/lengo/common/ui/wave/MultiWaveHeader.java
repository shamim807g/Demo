...
import static com.lengo.common.ui.wave.Util.setAlphaComponent;
...
public class MultiWaveHeader extends ViewGroup {
    ...
    public MultiWaveHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mWaveHeight = ta.getDimensionPixelOffset(R.styleable.MultiWaveHeader_mwhWaveHeight, Util.dp2px(30));
        mStartColor = ta.getColor(R.styleable.MultiWaveHeader_mwhStartColor, 0xFFE4554F);
        mCloseColor = ta.getColor(R.styleable.MultiWaveHeader_mwhCloseColor, 0xFFEF904E);
        mColorAlpha = ta.getFloat(R.styleable.MultiWaveHeader_mwhColorAlpha, 0.60f);
        mVelocity = ta.getFloat(R.styleable.MultiWaveHeader_mwhVelocity, 1f);
        mGradientAngle = ta.getInt(R.styleable.MultiWaveHeader_mwhGradientAngle, 290);
        ...
        mProgress = mCurProgress = ta.getFloat(R.styleable.MultiWaveHeader_mwhProgress, 1.0f);
