  ...
  val legendEntries = remember(data) {
    data.series.map { item ->
      LegendEntry(
        ...
        shape = ChartShape(
          color = item.color,
          shape = data.legendShape,
          size = data.legendShapeSize,
        )
      )
    }
  }
