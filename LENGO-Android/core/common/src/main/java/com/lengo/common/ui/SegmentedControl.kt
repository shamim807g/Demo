...
import com.lengo.common.ui.theme.thumbColor

@Preview
@Composable fun SegmentedDemo() {
    LENGOTheme {
        Surface {
            Column(Modifier.padding(16.dp).background(MaterialTheme.colors.surface), verticalArrangement = spacedBy(16.dp)) {
...
@Composable fun <T : Any> SegmentedControl(
    ...
    Layout(
        ...
        modifier = modifier
            ...
            .background(MaterialTheme.colors.secondaryVariant, BACKGROUND_SHAPE)
...
@Composable fun SegmentText(text: String) {
    Text(text, color = MaterialTheme.colors.onBackground, maxLines = 1, overflow = Ellipsis)
}
...
@Composable private fun Thumb(state: SegmentedControlState) {
    Box(
        Modifier
            ...
            .background(thumbColor(), BACKGROUND_SHAPE)
    )
}
